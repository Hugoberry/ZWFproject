...
#
SPIDER_MODULES = ['XinBDRedis.spiders']
NEWSPIDER_MODULE = 'XinBDRedis.spiders'
...
AUTOTHROTTLE_ENABLED = False  # 自动限速扩展
...
ITEM_PIPELINES = {
    'XinBDRedis.pipelines.XinBDRedisPipeline': 300,
...
DOWNLOADER_MIDDLEWARES = {
    'XinBDRedis.middlewares.RandMiddleware': 543,
    'XinBDRedis.middlewares.ProcessAllExceptionMiddleware': 544,
