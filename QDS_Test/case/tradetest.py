...
# class LoginDemo(DengLuPage):
#
#     def __init__(self, driver, req_url):
#         super(LoginDemo, self).__init__(self)
#         self.driver = driver
#         self.url = req_url
...
class TradeTest(MyTestCase):
    ...
    def test_trade_1(self):
        ...
        self.driver.find_element_by_css_selector(
            "body > div.section-banner > div.public-navbar > div > ul > li:nth-child(4) > a").click()
        ...
        # dl.refresh()
        # self.driver.set_window_size(1920, 1080)
        # x_t1 = [self.driver.title]
        # self.assertIn("商标咨询|商标注册咨询|商标线上咨询-权大师", x_t1)
        # print(self.driver.title)
        #
        # trade = unicode()
        # self.driver.find_element_by_css_selector(
        #     "div.item-right > div.search.suspend > input[type=\"text\"]").send_keys(trade)
        # print("商标名称:" + trade)
        # self.driver.find_element_by_css_selector(
        #     "div.item-right > div.search.suspend > a").click()
        # time.sleep(2)
        # windows = self.driver.window_handles
        # self.driver.switch_to.window(windows[-1])
        # dl = LoginDemo(self.driver, self.driver.current_url)
        # dl.login()
        # number = self.driver.find_element_by_css_selector(
        #     "div.page-content.w-center > div.page-content-left > div.search-top > i").text
        # number1 = int(number)
        # print("为您找到" + str(number) + "个商标")
        # time.sleep(1)
        # if int(number1) == 0:
        #     print("查无:" + str(trade) + "商标,发布求购需求!")
        #     self.driver.find_element_by_css_selector("div.no-search-data > a").click()
        #     fl = random.randint(1, 14)
        #     self.driver.find_element_by_xpath("//div[@class=\"recommend-help\"]/i").click()
        #     self.driver.find_element_by_xpath("//div[@id=\"selectCategoryType\"]/label[@data-type=\"1\"]").click()
        #     time.sleep(.5)
        #     # ActionChains(self.driver).move_to_element(self.driver.find_element_by_xpath('//div[@class="group-left"]/ul[@class="group scroll"]/li[3]/span')).perform()
        #     # if fl <= 31:
        #     #     self.driver.execute_script('document.querySelectorAll("ul.group.scroll li")[0].setAttribute("style", "position: relative;margin-top: -%dpx;")' % ((fl - 1) * 28))
        #     # else:
        #     #     self.driver.execute_script('document.querySelectorAll("ul.group.scroll li")[0].setAttribute("style", "position: relative;margin-top: -%dpx;")' % (30 * 28))
        #     # self.driver.find_element_by_xpath('//div[@class="group-left"]/ul[@class="group scroll"]/li[%d]/span' % fl).click()
        #     time.sleep(1)
        #     # print("选择" + str(fl) + "商标类别")
        #     # # 跳到第二层选取第几类中的具体详细类别
        #     # f2 = random.randint(1, 5)
        #     # self.driver.find_element_by_xpath('//div[@class="group-left"]/ul/li[@class="list open"]/div[%d]' % f2).click()
        #     # time.sleep(1)
        #     # # 第三层
        #     # try:
        #     #     for x in range(5):
        #     #         # self.driver.execute_script('document.querySelectorAll("div.title-second.open dl.second-sm dt")[%d].setAttribute("class", "row selected")' % x)
        #     #         self.driver.find_element_by_xpath('//div[@class="title-second open"]/dl/dt[%d]' % (x + 1)).click()
        #     # except Exception:
        #     #     pass
        #     # # 填写其他信息
        #     # true_url = self.driver.current_url
        #     # kw = re.compile(r"brandname=(.*)").findall(true_url)[0]
        #     # self.driver.find_element_by_xpath("//input[@class=\"myInput\"]").send_keys(unquote(kw))
        #     # self.driver.find_element_by_xpath("//a[@class=\"bottom getBrandPic\"]").click()
        #     # time.sleep(1)
        #     # self.driver.find_element_by_xpath('//a[@class="btn-step submitorder"]').click()
        #     # time.sleep(1)
        #     # self.driver.find_element_by_xpath('//a[@class="layui-layer-btn1"]').click()
        #     jg = random.randint(2, 9)
        #
        #     if jg == 4:
        #         self.driver.find_element_by_css_selector(
        ...
        #
        #     # # 公司名称
        #     # self.driver.find_element_by_xpath('//table[@class="table-1 table-applicant table-type1 active"]/tbody[@class="tbody-qiye"]/tr[1]/td[2]//dt[@class="select-text"]/input').send_keys("文思海域有限责任公司%d" % random.randint(1, 999))
        #     # # 添加社会信用代码
        #     # self.driver.find_element_by_xpath('//table[@class="table-1 table-applicant table-type1 active"]/tbody[@class="tbody-qiye"]/tr[2]/td[2]/input').send_keys(credit_code("credit_code.txt"))
        #     # # 公司地址
        #     # self.driver.find_element_by_xpath("//*[@id=\"ssq\"]").click()
        #     # time.sleep(2)
        #     # self.driver.find_element_by_xpath(
        #     #     "//*[@id=\"companylistrative\"]/div/div[2]/div[1]/dl[1]/dd/span[1]").click()
        #     # time.sleep(2)
        #     # self.driver.find_element_by_xpath(
        #     #     "//*[@id=\"companylistrative\"]/div/div[2]/div[2]/dl[2]/dd/span[1]").click()
        #     # time.sleep(1)
        #     # # 客户联系人
        #     # self.driver.find_element_by_xpath('//table[@class="table-1"]/tbody[@class="tbody-qiye"]/tr[1]/td[2]/input').send_keys("王思聪")
        #     # self.driver.find_element_by_xpath('//table[@class="table-1"]/tbody[@class="tbody-qiye"]/tr[2]/td[2]/input').send_keys("13867676767")
        #     # self.driver.find_element_by_xpath('//table[@class="table-1"]/tbody[@class="tbody-qiye"]/tr[3]/td[2]/input').send_keys("123456@qds.com")
        #     # self.driver.find_element_by_xpath('//a[@class="btn-step"]').click()
        #     # time.sleep(1)
        #     # self.driver.find_element_by_xpath('//a[@class="btn-step btn-next topay"]').click()
        #
        #     print("需求已发布!")
        #
        # else:
    ...
    def test_trade_10(self):
        ...
        dl.refresh()
        self.driver.set_window_size(1920, 1080)
        x_t2 = [self.driver.title]
        self.assertIn("商标交易_商标转让_商标买卖_商标交易网-权大师", x_t2)
        print(self.driver.title)
    ...
    def test_trade_13(self):
        ...
        self.driver.find_element_by_css_selector(
            "#personalCenter2-leftNav > ul > li:nth-child(3) > ul > li:nth-child(2)").click()
        ...
        info = self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page > div.tabsPanel > div > div.table-box > table > tbody > tr:nth-child(1) > td > div.td-content").text
        ...
        info2 = self.driver.find_element_by_css_selector(
            "#personalCenter2-rightContainer > div.order-page.brand-trade-page > div.tabsPanel > div > div.table-box > table > tbody > tr > td:nth-child(6) > div").text
        print(str(info2))
