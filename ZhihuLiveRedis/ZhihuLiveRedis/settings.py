# Scrapy settings for ZhihuLiveRedis project
#
...
#
SPIDER_MODULES = ['ZhihuLiveRedis.spiders']
NEWSPIDER_MODULE = 'ZhihuLiveRedis.spiders'
...
ITEM_PIPELINES = {
    'ZhihuLiveRedis.pipelines.ZhihulivePipeline': 300,
...
DOWNLOADER_MIDDLEWARES = {
    'ZhihuLiveRedis.middlewares.RandMiddleware': 543,
