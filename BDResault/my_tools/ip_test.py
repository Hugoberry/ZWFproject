...
redis_connect_pool = redis.ConnectionPool(host='10.0.7.6', port=6667, db=15, password='quandashi2018')
connect = redis.StrictRedis(connection_pool=redis_connect_pool, decode_responses=True)
proxy_key = 'proxy_key'
