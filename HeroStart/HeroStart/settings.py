# Scrapy settings for HeroStart project
#
...
#
SPIDER_MODULES = ['HeroStart.spiders']
NEWSPIDER_MODULE = 'HeroStart.spiders'
...
ITEM_PIPELINES = {
    'HeroStart.pipelines.HerostartPipeline': 300,
...
DOWNLOADER_MIDDLEWARES = {
    'HeroStart.middlewares.RandIPMiddleWare': 543,
    'HeroStart.middlewares.ProcessAllExceptionMiddleware': 544,
