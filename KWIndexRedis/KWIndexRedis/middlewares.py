...
class RandMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        # print(rua)
        # proxies = ['http://119.29.119.64:8080', 'http://111.197.238.158:9999', 'http://61.135.217.7:80']
...
class KwindexSpiderMiddleware(object):
...
class KwindexDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
