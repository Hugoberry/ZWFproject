...
class ZhTopicSpider(scrapy.Spider):
    name = 'zh_topic'
        ...
        try:
            if result['paging']['is_end'] == 'false' or 'False':
                for res in result['data']:
                    ...
                    item['questions_count'] = res['object']['questions_count'] if res['object']['questions_count'] else empty_word
                    item['avatar_url'] = res['object']['avatar_url'] if res['object']['avatar_url'] else empty_word
                    item['top_answer_count'] = res['object']['top_answer_count'] if res['object']['top_answer_count'] else empty_word
