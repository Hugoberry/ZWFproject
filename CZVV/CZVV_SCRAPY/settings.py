...
#
SPIDER_MODULES = ['CZVV_SCRAPY.spiders']
NEWSPIDER_MODULE = 'CZVV_SCRAPY.spiders'
...
ITEM_PIPELINES = {
    'CZVV_SCRAPY.pipelines.CzvvScrapyPipeline': 300,
    'scrapy_redis.pipelines.RedisPipeline': 400,
}

DOWNLOADER_MIDDLEWARES = {
    'CZVV_SCRAPY.middlewares.RandMiddleWare': 543,
