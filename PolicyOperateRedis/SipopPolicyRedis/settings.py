# Scrapy settings for SipopPolicyRedis project
#
...
#
SPIDER_MODULES = ['SipopPolicyRedis.spiders']
NEWSPIDER_MODULE = 'SipopPolicyRedis.spiders'
...
ITEM_PIPELINES = {
    'SipopPolicyRedis.pipelines.SipoppolicyPipeline': 300,
...
DOWNLOADER_MIDDLEWARES = {
    'SipopPolicyRedis.middlewares.RandMiddleware': 543,
