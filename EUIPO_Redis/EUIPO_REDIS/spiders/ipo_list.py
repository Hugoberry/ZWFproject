...
class IpoSpider(RedisSpider):
    ...
    def __init__(self):
        ...
        self.cookie = IPCookie().get_cookies()
    ...
    def parse(self, response):
        ...
        for page in range(int(num) * 1000, int(num) * 1000 + 1000):
            ...
            yield scrapy.FormRequest(url=first_url, formdata=data, callback=self.parse_json, cookies=self.cookie, meta={'num': str(int(num * 100))})
