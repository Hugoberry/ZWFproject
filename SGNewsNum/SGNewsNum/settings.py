# Scrapy settings for SGNewsNum project
#
...
#
SPIDER_MODULES = ['SGNewsNum.spiders']
NEWSPIDER_MODULE = 'SGNewsNum.spiders'
...
ITEM_PIPELINES = {
    'SGNewsNum.pipelines.SearchPipeline': 300,
...
DOWNLOADER_MIDDLEWARES = {
    'SGNewsNum.middlewares.RandMiddleware': 543,
    'SGNewsNum.middlewares.ProcessAllExceptionMiddleware': 544,
    'scrapy.contrib.downloadermiddleware.useragent.UserAgentMiddleware': None,
}
TELNETCONSOLE_ENABLED = True
TELNETCONSOLE_PORT = [6023, 6073]
# LOG_FILE = 'news_bug.log'

# EXTENSIONS = {
#     'SGNewsNum.signals_extensinon.ControlExtension': 500,
# }
