# Scrapy settings for B2B project
#
...
#
SPIDER_MODULES = ['B2B.spiders']
NEWSPIDER_MODULE = 'B2B.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'B2B.middlewares.RandIPMiddleWare': 543,
    'B2B.middlewares.ProcessAllExceptionMiddleware': 544,
